 ...
 * @author proxc
 */
public class StudentLaboratoryExercisesPage extends javax.swing.JFrame {
     ...
     */
    public StudentLaboratoryExercisesPage() {
        laboratoryExercise = null;
        initComponents();
    }

    public void setData(String identifier) {
        this.student = studentService.getStudentByIdentifier(identifier);
        initEntityTable();
    }
    ...
    private void initEntityTable() {
        ...
        List<LaboratoryExercise> laboratoryExercises = laboratoryExerciseService.getGroupLaboratoryExercises(student.getGroup().getId());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(StudentLaboratoryExercisesPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new StudentLaboratoryExercisesPage().setVisible(true);
            }
        });
    }
