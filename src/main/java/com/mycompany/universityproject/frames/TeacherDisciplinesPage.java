 ...
 * @author proxc
 */
public class TeacherDisciplinesPage extends javax.swing.JFrame implements ChangeGradeListener {

    GradeStudentPage gradeStudentPage = new GradeStudentPage();
    TeacherService teacherService = new TeacherService();

    boolean openedGrades = false;
    ...
    private void initComponents() {
        ...
        studentsList = new javax.swing.JPanel();
        ...
        listButton.setText("My Disciplines");
        ...
        studentsList.setLayout(new javax.swing.BoxLayout(studentsList, javax.swing.BoxLayout.LINE_AXIS));
        ...
        studentsList.add(studentsScrollPane);

        home.add(studentsList, "card3");
    ...
    private void initDisciplinesTable() {
        ...
        List<Discipline> disciplines = disciplineService.getDisciplinesByTeacher(currentTeacher.getId());
    ...
    private void listButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_listButtonMouseClicked
        ...
        disciplinesList.setVisible(true);
    ...
    private void editButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_editButtonMouseClicked
        ...
        String disciplineName = disciplinesTable.getModel().getValueAt(row, column).toString();
        ...
        disciplinesList.setVisible(false);
    ...
    private void initStudentsTable() {
        ...
        String[] columnNames = {"Faculty Number", "Identifier", "Name","Email", "Speciality", "Course", "Group", "Grade"};

        StudentService studentService = new StudentService();
        List<Student> students = studentService.getStudentsByCourse(currentDiscipline.getCourse().getId());
        ...
        for(Student student : students) {
            ...
            StudentGrade studentGrade = studentGradeService.getStudentGrade(currentDiscipline.getId(), student.getId());

            data[index][7] = studentGrade == null ? "Not Graded" : studentGrade.getGrade();
            index++;
        }
        ...
        TeacherDisciplinesPage teacherDisciplinesPage = this;
        ...
        studentsTable.addMouseListener(new MouseAdapter() {
            public void mousePressed(MouseEvent mouseEvent) {
                ...
                gradeStudentPage.setVisible(true);
                gradeStudentPage.setData( studentService.getStudentByFacultyNumber(facultyNumber), currentDiscipline, teacherDisciplinesPage);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TeacherDisciplinesPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TeacherDisciplinesPage().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JPanel studentsList;
    private javax.swing.JScrollPane studentsScrollPane;
    private javax.swing.JTable studentsTable;

    public void setTeacher(User user) {

        currentTeacher = teacherService.getTeacher(user.getIdentifier());
        initDisciplinesTable();
    }

    @Override
    public void OnChangeGradeListener() {
        initStudentsTable();
        openedGrades = false;
    }
